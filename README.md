...
- (опционально) `HORDE_STEPS`, `HORDE_WIDTH`, `HORDE_HEIGHT`, `HORDE_DENOISING`, `HORDE_TIMEOUT_MS`, `HORDE_HTTP_TIMEOUT_MS` — настройки качества/скорости (если видишь aborted/timeout — увеличь `HORDE_HTTP_TIMEOUT_MS`)
